...
//   medicationName: string;
//   dosage: string;
//   time: any; // Firestore Timestamp or Date
//   days: string[];
//   createdAt: any;
//   notificationIds?: string[];
// }
...
//     if (!hasPermission) return notificationIds;

//     try {
//       // Convert Firestore Timestamp to Date if needed
//       const notificationTime = time instanceof Date ? time : time.toDate();
//       notificationTime.setSeconds(0, 0);

//       for (const dayId of days) {
//         const dayNumber = parseInt(dayId);
//         // Map to NotificationTriggerInput's weekday (1-7, Sunday=1)
...
//       // Cancel any notifications that were successfully scheduled before the error
//       for (const id of notificationIds) {
//         await Notifications.cancelScheduledNotificationAsync(id).catch(e => console.error('Error canceling notification:', e));
//       }
//       throw error;
//     }
...
//         medicationName,
//         dosage,
//         time: fieldValue.serverTimestamp(), // Using server timestamp
//         days: selectedDays,
//         createdAt: fieldValue.serverTimestamp(),
//         notificationIds: [] // Initialize empty array
//       };
...
//       // Schedule notifications
//       const notificationIds = await scheduleNotifications(medicationRef.id, {
//         ...medicationData,
//         time // Use local time for scheduling
//       });

//       // Update the document with notification IDs
//       await medicationRef.update({
//         notificationIds,
//         time: fieldValue.serverTimestamp() // Update time again if needed
//       });
...
//             Notifications.cancelScheduledNotificationAsync(id).catch(e => console.error('Error canceling notification:', e))
//           )
//         );
//       }
...
//     const date = time instanceof Date ? time : time?.toDate?.();
...
//           </Text>
//           {isAdding && <ActivityIndicator size="small" color="#fff" style={styles.loader} />}
//         </TouchableOpacity>
//       </View>
